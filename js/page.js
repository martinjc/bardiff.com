...
(function() {
    ...
    var single_day_chart = new SingleDayChart("#pastday .vis", {
        top: 10,
        bottom: 70,
        left: 50,
        right: 10
    ...
    function past_24_hours(stats, now, yesterday) {
        ...
        var data = d3.nest()
            .key(function(d) {
                return new Date(d.time.getFullYear(), d.time.getMonth(), d.time.getDate(), d.time.getHours(), d.time.getMinutes());
            })
    ...
    function do_dashboard(date_query) {
        ...
        queue()
            .defer(d3.xhr, "https://bardiff-martinjc.rhcloud.com/api/venues" + date_query)
            .defer(d3.xhr, "https://bardiff-martinjc.rhcloud.com/api/breweries" + date_query)
            .defer(d3.xhr, "https://bardiff-martinjc.rhcloud.com/api/beers" + date_query)
            .defer(d3.xhr, "https://bardiff-martinjc.rhcloud.com/api/checkins" + date_query)
            .defer(d3.xhr, "https://bardiff-martinjc.rhcloud.com/api/checkins" + previous_day)
